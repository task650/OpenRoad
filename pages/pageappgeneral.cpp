...
OpenroadInterface *PageAppGeneral::openroad() const
{
    return mOpenroad;
}

void PageAppGeneral::setOpenroad(OpenroadInterface *openroad)
{
    mOpenroad = openroad;
...
void PageAppGeneral::reloadParams()
{
    if (mOpenroad) {
        ...
        ui->appTab->addParamSubgroup(mOpenroad->appConfig(), "general", "general");
    }
}
